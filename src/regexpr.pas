...
type
  ...
  PLookAroundInfo = ^TLookAroundInfo;
  TLookAroundInfo = record
    ...
    OuterInfo: PLookAroundInfo; // for nested lookaround
  end;
  ...
  private
    ...
    LookAroundInfoList: PLookAroundInfo;
...
var
  ...
  LookAroundInfoPtr: PLookAroundInfo;
begin
  Result := False;
  {
